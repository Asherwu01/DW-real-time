package com.asher.mock
import java.util.Date

import com.alibaba.fastjson.{JSON, JSONObject}
import com.asher.mock.util.{LogUploader, RandomNumUtil, RandomOptions}
...
object JsonMock {
  ...
  val eventOpts = RandomOptions(
    ...
    ("addCart", 20), ("clickItem", 1), ("coupon", 80))
  ...
  def initOneStartupLog(): String = {
     ...
     */
    val mid: String = "mid_" + RandomNumUtil.randomInt(1, 6) //500
    val uid: String = "uid" + RandomNumUtil.randomInt(1, 10000)
